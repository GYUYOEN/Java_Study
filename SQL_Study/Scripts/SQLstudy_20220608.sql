...
ALTER TABLE EMP202206 ADD PHONE NUMBER;
ALTER TABLE EMP202206 DROP COLUMN EMAIL;

ALTER TABLE EMP202206 ADD COUNTRY VARCHAR2(30) DEFAULT 'KOREA';

ALTER TABLE EMP202206 ADD CONSTRAINT PK_EMP202206_EMP_NO PRIMARY KEY(EMP_NO);
...
ALTER TABLE student_t ADD CONSTRAINT PK_student_t_STU_ID PRIMARY KEY(stu_id);
ALTER TABLE student_t MODIFY stu_name CONSTRAINT NN_student_t_STUD_NAME NOT NULL;

CREATE TABLE subject_t(
	   stu_id NUMBER
	 , sub_no VARCHAR2(10)
	 , sub_name VARCHAR2(10)
	 , sub_score VARCHAR2(3)
);
...
COMMENT ON COLUMN subject_t.sub_score IS '함수';

SELECT * FROM USER_COL_COMMENTS WHERE TABLE_NAME = 'SUBJECT_T';

ALTER TABLE subject_t ADD CONSTRAINT FK_subject_t_STU_ID FOREIGN KEY(stu_id) REFERENCES student_t(stu_id);

ALTER TABLE subject_t MODIFY sub_name CONSTRAINT CK_subject_t_SUB_NAME CHECK(sub_name IN ('국어', '영어', '수학', '과학'));
...
ALTER TABLE STUDENT DROP CONSTRAINT SYS_C0010764;
ALTER TABLE STUDENT ADD CONSTRAINT PK_STUDENT_STU_NO PRIMARY KEY(STU_NO);
ALTER TABLE STUDENT DROP CONSTRAINT SYS_C0010765;
ALTER TABLE STUDENT ADD CONSTRAINT FK_STUDENT_STU_NO FOREIGN KEY(STU_NO) REFERENCES STUDENT_LEVEL(STU_NO);
ALTER TABLE STUDENT DROP CONSTRAINT SYS_C0010763;
ALTER TABLE STUDENT MODIFY STU_NAME CONSTRAINT NN_STUDENT_STU_NAME NOT NULL;

CREATE TABLE STUDENT_LEVEL(
	   STU_NO VARCHAR2(10)
	 , LEVEL_NO VARCHAR2(10)
	 , CLASS VARCHAR2(10)
	 , TEACHER VARCHAR2(10) 
...
ALTER TABLE MART_T MODIFY company DEFAULT '없음';
ALTER TABLE MART_T MODIFY possible CHECK(POSSIBLE IN('O', 'X'));
ALTER TABLE MART_T ADD CONSTRAINT PK_MART_T_NAME PRIMARY KEY(name);
ALTER TABLE MART_T ADD FOREIGN KEY(barcode) REFERENCES ref_mart_t(r_bar);
